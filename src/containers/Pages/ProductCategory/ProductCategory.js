...
import ProductCategoryDetail from "./ProductCategoryDetailModal";
      ...
      <div className="container-fluid mt-5">
        <div className="d-flex justify-content-center">
          <div className="col-lg-12 col-md-12">
            ...
            <ProductCategoryDetail toggle={this.toggle} isOpen={isOpen} />
...
export default connect(mapStateToProps, mapActionToProps)(ProductCategory);
